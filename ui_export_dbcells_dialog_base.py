...
class Ui_ExportDBCellsDialogBase(object):
    def setupUi(self, ExportDBCellsDialogBase):
        ...
        self.comboRDF = QtWidgets.QComboBox(ExportDBCellsDialogBase)
        self.comboRDF.setMaximumSize(QtCore.QSize(300, 16777215))
        self.comboRDF.setObjectName("comboRDF")
        self.horizontalLayout.addWidget(self.comboRDF)
    ...
    def retranslateUi(self, ExportDBCellsDialogBase):
        ...
        self.labelRDF.setText(_translate("ExportDBCellsDialogBase", "RDF File"))
